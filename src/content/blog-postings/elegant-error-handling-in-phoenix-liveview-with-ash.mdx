...
Good products think about their failure states. A blank 500 page, or that classic `no view was found for the format: 'html'` error, yanks people right out of the experience. Those moments are part of the product too. Calm copy. A useful next step. A system that still feels like it knows where it is.
